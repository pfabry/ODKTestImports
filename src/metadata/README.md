 ...
 * [ODKTestImports.yml](ODKTestImports.yml)
     * Determines how your purl.obolibrary.org/obo/ODKTestImports/ redirects will be handled
     ...
     * Paste in the contents of [ODKTestImports.yml](ODKTestImports.yml)
 ...
 * [ODKTestImports.md](ODKTestImports.md)
     ...
     * Paste in the contents of [ODKTestImports.md](ODKTestImports.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
